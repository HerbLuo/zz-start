...
interface IAttachmentService {
     ...
     * @return 附件列表
     */
    fun getAttachments(business: String, businessId: Long): List<Attachment>
     ...
     * @return 是否更新成功
     */
    fun update(attachment: Attachment): Boolean
     ...
     * @throws IOException .
     */
    fun upload(business: String, businessId: Long, file: MultipartFile): Attachment
     ...
     * @throws IOException .
     */
    fun uploadOrReplace(business: String, businessId: Long, file: MultipartFile): Attachment
     ...
     * @return url
     */
    fun genUrl(attachment: Attachment): String
